...
type TranslationKey =
  ...
  | 'text.side-menu.profile'
  | 'text.side-menu.change-password'
  | 'text.side-menu.logout'
  | 'text.side-menu.appearance'
  | 'text.side-menu.light-mode'
  | 'text.side-menu.dark-mode'
  | 'text.side-menu.language'
  ...
  | 'text.table-column.column-user-guide-file-name'
  ...
  | 'text.table-column.column-initial'
  | 'text.table-column.column-address'
  | 'text.table-column.column-city'
  | 'text.table-column.column-region'
